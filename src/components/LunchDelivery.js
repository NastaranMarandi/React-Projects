...
const lunchMenu=menu.filter((restaurant) => restaurant.mealType.title=== "Lunch & Dinner");


export default class LunchDelivery extends Component {
  render() {
          ...
          <Container fluid style={{marginTop:'5rem'}}>
            <Grid.Row style={{ padding: '0 4rem' }}>
              <div className='offerSliderHeader'>
                <Header style={{paddingLeft:'1rem',marginBottom:'1.5rem'}} size='large'>Lunch Delivery in San Francisco Bay Area</Header>
              </div>
              <Slider {...settings}>
                {lunchMenu.map(restaurant => (
                  ...
                  <div className="DeliverySliderDetails">
                  <span>4.6</span>
                  </div>
